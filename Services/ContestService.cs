...
namespace Judge1.Services
{
    public interface IContestService
    {
        ...
        public Task<List<ContestInfoDto>> GetOngoingContestInfosAsync(string userId);
    ...
    public class ContestService : IContestService
    {
        ...
        public async Task<List<ContestInfoDto>> GetOngoingContestInfosAsync(string userId)
        {
