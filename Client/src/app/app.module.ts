...
import {ReviewFeedbackDetailComponent} from "./components/reviewFeedback/detail/detail.component";
    ...
    RouterModule.forRoot([
      ...
      {path: 'contests', component: ContestListComponent, canActivate: [AuthorizeGuard]},
      {
        ...
        children: [
          ...
          {path: 'problem/:problemId/reviewFeedback', component: ReviewFeedbackDetailComponent},
