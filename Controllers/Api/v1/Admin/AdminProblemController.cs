...
namespace Judge1.Controllers.Api.v1.Admin
{
    ...
    public class AdminProblemController : ControllerBase
    {
        ...
        public async Task<ActionResult<ContestEditDto>> CreateProblem(ProblemEditDto dto)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<ContestEditDto>> UpdateProblem(int id, ProblemEditDto dto)
        {
            try
            {
