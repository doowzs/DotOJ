export const Languages: { code: number, name: string, mode: string, env: string, option: string }[] = [
  {
...
export const Verdicts: { code: number, name: string, showCase: boolean, stage: number, explain: string }[] = [
  {
